...
def process_song_data(spark, input_data, output_data):
    """
        Read song data then process the data to extract songs and artists information to S3. 
...
def process_log_data(spark, input_data, output_data):
    """
       Read log data then process the data to extract user, time, and songplay information to S3. 
    """
...
def main():
    ...
    input_data = "s3a://udacity-dend/"
    output_data ="s3a://dend-bucket-sara/"
